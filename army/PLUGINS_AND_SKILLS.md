...
| 11 | **superpowers** (v5.0.2) | Core skills library for Claude Code: TDD, debugging, collaboration patterns, and proven techniques | [obra/superpowers](https://github.com/obra/superpowers) via `claude-plugins-official` | `/plugin install superpowers@claude-plugins-official` |

...
import (
	...
	"github.com/smahovkic/agent-army/army/internal/core/detector"
...
func (m SetupModel) View() string {
	...
	s.WriteString(titleStyle.Render("army setup") + "\n\n")
...
func (m SetupModel) viewDone() string {
	...
	s.WriteString("  Run 'army sync' to install your selections.\n")
	return s.String()
}

...
Project React and TypeScript patterns are automatically loaded via Cursor rules (`103-react.mdc`, `101-typescript.mdc`).
...
Follow the coverage thresholds (auto-loaded via `502-cross-cutting.mdc`):

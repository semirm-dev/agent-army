---
name: react/coder
description: Drives end-to-end React implementation from props-first component design through hook extraction, state management selection, accessibility compliance, and pre-PR verification checklists.

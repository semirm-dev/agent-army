...
languages: [react]
access: read-write
uses_skills: [react/coder, react/architect, error-handling, code-architecture, refactoring-patterns]
...
6. For restructuring existing components, invoke the `refactoring-patterns` skill
7. For project scaffolding or major component library restructuring, invoke the `react/architect` skill
